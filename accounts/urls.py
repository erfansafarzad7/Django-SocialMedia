...
urlpatterns = [
    ...
    path('reset/done/', views.UserPasswordResetSendView.as_view(), name='password_reset_send'),
    path('confirm/<uidb64>/<token>/', views.UserPasswordResetConfirmView.as_view(), name='password_reset_confirm'),
    path('confirm/complete/', views.UserPasswordResetCompeleteView.as_view(), name='password_reset_complete'),
